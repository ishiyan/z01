...
{
    [TestClass]
    public class MesaFollowingAdaptiveMovingAverageBandTest
    {
        #region Test data
        /// <summary>
        ...
        {
            var target = new MesaFollowingAdaptiveMovingAverageBand();
        ...
        public void MonikerTest()
        {
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(20, 5);
            //Assert.AreEqual("MAMA/FAMA4(5,20)", target.Moniker);
            target = new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0.01, fastLimit:0.8);
        ...
        public void SlowLimitTest()
        {
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(19, 7);
        ...
        public void SmoothingLengthTest()
        {
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(4);
            //Assert.AreEqual(4, target.SmoothingLength);
            //target = new MesaFollowingAdaptiveMovingAverageBand(3);
            //Assert.AreEqual(3, target.SmoothingLength);
            //target = new MesaFollowingAdaptiveMovingAverageBand(2);
        ...
        /// </summary>
        [TestMethod]
        public void MesaAdaptiveMovingAverageBandConstructorTest()
        {
            var target = new MesaFollowingAdaptiveMovingAverageBand();
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            ...
            target = new MesaFollowingAdaptiveMovingAverageBand(ohlcvComponent:OhlcvComponent.TypicalPrice);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            Assert.AreEqual(39, target.SlowLimitLength);
            Assert.AreEqual(0.5, target.FastLimit);
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(2, OhlcvComponent.OpeningPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            Assert.AreEqual(39, target.SlowLimitLength);
            Assert.AreEqual(0.5, target.FastLimit);
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(199, 7);
            Assert.AreEqual(4, target.SmoothingLength);
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(199, 7, 2);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(199, 7, 2, OhlcvComponent.LowPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0.01, fastLimit:0.25);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0.01, fastLimit:0.25, 2);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            //target = new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0.01, fastLimit:0.25, 2, ohlcvComponent:OhlcvComponent.HighPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
        ...
        public void MesaAdaptiveMovingAverageBandConstructorTest2()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:5);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest3()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:1);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest4()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest5()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:-8);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest6()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0, fastLimit:2);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest7()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:-7, fastLimit:2);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest8()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:199, fastLimit:0);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest9()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:199, fastLimit:-7);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest10()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:1.01, fastLimit:0.3);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest11()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0, fastLimit:0.3);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest12()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:-0.01, fastLimit:0.3);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest13()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0.3, fastLimit:1.01);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest14()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0.3, fastLimit:0);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandConstructorTest15()
        {
            // ReSharper disable once ObjectCreationAsStatement
            new MesaFollowingAdaptiveMovingAverageBand(slowLimit:0.3, fastLimit:-0.01);
        }
        #endregion

        #region SerializationTest
        private static void SerializeTo(MesaFollowingAdaptiveMovingAverageBand instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(MesaFollowingAdaptiveMovingAverageBand), null, 65536, false, true, null);
        ...
        private static MesaFollowingAdaptiveMovingAverageBand DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(MesaFollowingAdaptiveMovingAverageBand), null, 65536, false, true, null);
            var instance = (MesaFollowingAdaptiveMovingAverageBand)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        public void SerializationTest()
        {
            ...
            Band band;
            double d, u; const int digits = 9;
            var source = new MesaFollowingAdaptiveMovingAverageBand();
            // Tradestation implementation skips first 9 bars.
            for (int i = 9; i < 99; i++)
            {
            ...
            const string fileName = "MesaAdaptiveMovingAverageBand_1.xml";
            SerializeTo(source, fileName);
            MesaFollowingAdaptiveMovingAverageBand target = DeserializeFrom(fileName);
