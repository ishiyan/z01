...
namespace Mbst.Trading.Indicators
{
    ...
    public sealed class AutocorrelationSpectrum : Indicator, IHeatmapIndicator
    {
        ...
        public AutocorrelationSpectrum(Color minRasterColor, Color midRasterColor, Color maxRasterColor,
            ColorInterpolationType minMidColorInterpolationType, ColorInterpolationType midMaxColorInterpolationType,
            int length = 48, int minPeriod = 10, int maxPeriod = 47, int spectrumResolution = 1,
        ...
        public AutocorrelationSpectrum(int length = 48, int minPeriod = 10, int maxPeriod = 47, int spectrumResolution = 1,
            ...
            length, minPeriod, maxPeriod, spectrumResolution, averagingLength, isSmoothed, isAutomaticGainControl,
            automaticGainControlDecayFactor, ohlcvComponent, floatingNormalization)
        {
        }
        #endregion
