...
namespace Mbst.Trading.Indicators
{
    ...
    public sealed class DiscreteFourierTransformSpectrum : Indicator, IHeatmapIndicator
    {
        ...
        [DataMember]
        private DiscreteFourierTransformSpectrumEstimator estimator;
        [DataMember]
        ...
        private const string dfts = "psDft";
        private const string dftsFull = "Power spectrum estimation based on discrete Fourier transform";
        ...
        public DiscreteFourierTransformSpectrum(Color minRasterColor, Color midRasterColor, Color maxRasterColor,
            ColorInterpolationType minMidColorInterpolationType, ColorInterpolationType midMaxColorInterpolationType,
            int length = 48, int minPeriod = 10, int maxPeriod = 48, int spectrumResolution = 1,
            ...
            : base(dfts, dftsFull, ohlcvComponent)
        {
            if (2 > length)
            ...
            moniker = string.Concat(dfts, length.ToString(CultureInfo.InvariantCulture));
        ...
        public DiscreteFourierTransformSpectrum(int length = 48, int minPeriod = 10, int maxPeriod = 48, int spectrumResolution = 1,
            ...
            double automaticGainControlDecayFactor = 0.995, OhlcvComponent ohlcvComponent = OhlcvComponent.MedianPrice,
