...
{
    /// <summary>
    /// Estimates sample Pearson autocorrelation coefficients.
    /// </summary>
    [DataContract]
    internal sealed class AutocorrelationEstimator
    {
        ...
        /// <summary>
        /// The maximal lag is equal to the observed time lapse (Lenth).
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// A minimum value of the estimated correlation coefficients. The mimimal possible value is -1.
        /// </summary>
        [DataMember]
        ...
        #region Calculate
        /// <summary>
        /// Calculates sample autocorrelation Pearson coefficients of the <c>InputSeries</c> using stable algorithm.
...
/*
        /// <summary>
        /// Calculates sample autocorrelation Pearson coefficients of the <c>InputSeries</c> using unstable algorithm.
        /// The <c>InputSeries</c> must be filled before this call.
        /// </summary>
        public void Calculate()
        {
