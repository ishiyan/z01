...
namespace Mbst.Trading.Indicators
{
    ...
    public sealed class MaximumEntropySpectrum : Indicator, IHeatmapIndicator
    {
        ...
        #region Degree
        /// <summary>
        /// The degree (order) of the autoregression.
        /// </summary>
        [DataMember]
        public int Degree { get { return estimator.Degree; } }
        #endregion
        ...
        [DataMember]
        private MaximumEntropySpectrumEstimator estimator;
        [DataMember]
        ...
        /// <param name="degree">The degree (order) of autoregression.</param>
        ...
        public MaximumEntropySpectrum(Color minRasterColor, Color midRasterColor, Color maxRasterColor,
            ColorInterpolationType minMidColorInterpolationType, ColorInterpolationType midMaxColorInterpolationType,
            int length = 60, int degree = 30, int minPeriod = 2, int maxPeriod = 59, int spectrumResolution = 1,
        ...
        /// <summary>
        /// Constructs a new instance of the <see cref="MaximumEntropySpectrum"/> class.
        /// </summary>
        /// <param name="length">The number of time periods in the spectrum window.</param>
        /// <param name="degree">The degree (order) of autoregression.</param>
        /// <param name="minPeriod">The minimum period to calculate, must be less than the <c>maxPeriod</c>.</param>
        ...
        /// <param name="ohlcvComponent">The Ohlcv component.</param>
        /// <param name="floatingNormalization">Specifies if to use the floating normalization.</param>
        public MaximumEntropySpectrum(int length = 60, int degree = 30, int minPeriod = 2, int maxPeriod = 59,
            int spectrumResolution = 1, bool isAutomaticGainControl = true, double automaticGainControlDecayFactor = 0.995,
            OhlcvComponent ohlcvComponent = OhlcvComponent.MedianPrice, bool floatingNormalization = true)
            ...
            length, degree, minPeriod, maxPeriod, spectrumResolution, isAutomaticGainControl, automaticGainControlDecayFactor,
        ...
        public override string ToString()
        {
            ...
            lock (updateLock)
            {
                ...
                l = estimator.Length;
                d = estimator.Degree;
                r = estimator.SpectrumResolution;
            }
