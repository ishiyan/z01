...
{
    [TestClass]
    public class MovingAverageConvergenceDivergenceHistogramBandTest
    {
        #region Test data
        /// <summary>
        ...
        {
            var target = new MovingAverageConvergenceDivergenceHistogramBand(new MovingAverageConvergenceDivergence());
        ...
        public void ParentTest()
        {
            ...
            var target = new MovingAverageConvergenceDivergenceHistogramBand(parent);
        ...
        {
            var target = new MovingAverageConvergenceDivergenceHistogramBand(new MovingAverageConvergenceDivergence());
            Assert.AreEqual("Moving Average Convergence/Divergence histogram band", target.Description);
        }
        #endregion
        ...
        public void TaLibHistogramTest()
        {
            ...
            for (int i = 33; i < count; ++i)
            {
                ...
                Assert.AreEqual(u, d);
                Assert.AreEqual(0d, target.Value.SecondValue);
                Assert.AreEqual(dateTime, target.Value.Time);
            }
        }
        #endregion
        ...
        public void TaLibHistogramTestMetastock()
        {
            ...
            for (int i = 33; i < count; ++i)
            {
                ...
                u = target.Value.FirstValue;
                Assert.IsFalse(double.IsNaN(u));
                Assert.IsFalse(double.IsNaN(target.Value.SecondValue));
                double d = Math.Round(u, digits);
        ...
        public void ValueTest()
        {
            ...
            for (int i = 33; i < count; ++i)
            {
                ...
                double u = Math.Round(parent.Histogram, digits);
                Assert.AreEqual(u, d);
                Assert.AreEqual(0d, target.Value.SecondValue);
                Assert.AreEqual(dateTime, target.Value.Time);
            }
        ...
        #region MovingAverageConvergenceDivergenceHistogramBandConstructorTest
        /// <summary>
        /// A test for MovingAverageConvergenceDivergenceHistogramBand Constructor.
        /// </summary>
        [TestMethod]
        public void MovingAverageConvergenceDivergenceHistogramBandConstructorTest()
        {
            var parent = new MovingAverageConvergenceDivergence();
            var target = new MovingAverageConvergenceDivergenceHistogramBand(parent);
        ...
        private static void SerializeTo(MovingAverageConvergenceDivergenceHistogramBand instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(MovingAverageConvergenceDivergenceHistogramBand),
        ...
        private static MovingAverageConvergenceDivergenceHistogramBand DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(MovingAverageConvergenceDivergenceHistogramBand),
                null, 65536, false, true, null);
            var instance = (MovingAverageConvergenceDivergenceHistogramBand)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        public void SerializationTest()
        {
            ...
            int count = input.Count;
            var parent = new MovingAverageConvergenceDivergence();
            var source = new MovingAverageConvergenceDivergenceHistogramBand(parent);
            DateTime dateTime;
            Band band;
            for (int i = 0; i < 33; ++i)
            {
            ...
            for (int i = 33; i < 92; ++i)
            {
                ...
                u = Math.Round(expectedHist[i], digits);
                Assert.AreEqual(u, d);
                Assert.AreEqual(0d, source.Value.SecondValue);
                Assert.AreEqual(dateTime, source.Value.Time);
            }
            const string fileName = "MovingAverageConvergenceDivergenceHistogramBandTest_1.xml";
            SerializeTo(source, fileName);
            MovingAverageConvergenceDivergenceHistogramBand target = DeserializeFrom(fileName);
            Assert.IsTrue(target.IsPrimed);
            Assert.AreEqual("MACDh", target.Name);
