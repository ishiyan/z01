...
namespace Tests.Indicators.JohnEhlers
{
    ...
    public class SineWaveBandTest
    {
        ...
        public void MonikerTest()
        {
            ...
            //target = new SineWaveBand(4);
            //Assert.AreEqual("SineBand4", target.Moniker);
            target = new SineWaveBand(/*3*/);
            Assert.AreEqual("SineBand3", target.Moniker);
            target = new SineWaveBand(/*2*/);
        ...
        /// </summary>
        [TestMethod]
        public void SineWaveBandConstructorTest()
        {
            var target = new SineWaveBand();
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.IsFalse(target.IsPrimed);
            ...
            target = new SineWaveBand(ohlcvComponent:OhlcvComponent.TypicalPrice);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.IsFalse(target.IsPrimed);
            ...
            target = new SineWaveBand(/*3,*/ ohlcvComponent:OhlcvComponent.OpeningPrice);
            Assert.AreEqual(3, target.SmoothingLength);
            Assert.IsFalse(target.IsPrimed);
            ...
            target = new SineWaveBand(/*2,*/ ohlcvComponent:OhlcvComponent.OpeningPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.IsFalse(target.IsPrimed);
            Assert.IsTrue(target.OhlcvComponent == OhlcvComponent.OpeningPrice);
        }
        ...
        public void SineWaveBandConstructorTest2()
        {
            var target = new SineWaveBand(/*5*/);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void SineWaveBandConstructorTest3()
        {
            var target = new SineWaveBand(/*1*/);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void SineWaveBandConstructorTest4()
        {
            var target = new SineWaveBand(/*0*/);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void SineWaveBandConstructorTest5()
        {
            var target = new SineWaveBand(/*-8*/);
            Assert.IsFalse(target.IsPrimed);
        }
        #endregion

        #region SerializationTest
        private static void SerializeTo(SineWaveBand instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(SineWaveBand), null, 65536, false, true, null);
        ...
        private static SineWaveBand DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(SineWaveBand), null, 65536, false, true, null);
            var instance = (SineWaveBand)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        public void SerializationTest()
        {
            ...
            const string fileName = "SineWaveBand_1.xml";
            SerializeTo(source, fileName);
            SineWaveBand target = DeserializeFrom(fileName);
