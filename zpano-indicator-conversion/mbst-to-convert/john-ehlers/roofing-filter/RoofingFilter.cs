...
namespace Mbst.Trading.Indicators
{
    ...
    public sealed class RoofingFilter : Indicator, ILineIndicator
    {
        ...
        public RoofingFilter(int shortestCyclePeriod = 10, int longestCyclePeriod = 48, OhlcvComponent ohlcvComponent = OhlcvComponent.MedianPrice,
